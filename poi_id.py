...
from helper_functions import plotting_salary_expenses
from helper_functions import dataset_info

### Task 1: Select what features you'll use.
### features_list is a list of strings, each of which is a feature name.
### The first feature must be "poi".
features_list = ['poi','salary','expenses', 'from_poi_to_this_person', 'from_this_person_to_poi'] # You will need to use more features
